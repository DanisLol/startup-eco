...
export const FIXTURE_FAMILY_CODE = "MIA4K2";
export const FIXTURE_CHILD_NAME = "Mia";
export const FIXTURE_CHILD_AGE = 7;
export const FIXTURE_TOPIC = "volcanoes";

export const FIXTURE_ROADMAP = [
...
/**
 * Hand-written volcano lesson so the kid UI can render without waiting on the model.
 */
export const fixtureArtifact: LessonArtifact = {
  ...
  steps: [
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation:
        "Magma is rock that got so hot it melted. It lives under the ground until a volcano lets it out.",
    },
    {
      id: "explain-2",
      type: "explain",
    ...
    },
    {
      ...
      correctIndex: 2,
      explanation:
        "Inside the mountain it is magma. The moment it comes out, we call it lava.",
    },
    {
      id: "reflect-1",
      type: "reflect",
      prompt:
        "If you could stand somewhere safe and watch a volcano, what would you want to look at first? Tell your grown-up in a sentence.",
    },
  ],
  wrapUp:
    "You learned that magma is melted rock, lava is magma that comes out, and volcanoes erupt when that hot rock finds a way up. Next time you see a picture of a volcano, you will know what is happening inside.",
};
